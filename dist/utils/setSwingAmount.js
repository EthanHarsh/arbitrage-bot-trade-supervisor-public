...
function setSwingAmount(tokenBalances, stats, sell, buy, sellPrice, buyPrice, swingTradeAmount) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4, findAmounts(sellObj, buyObj, stats, swingTradeAmount)];
                case 1:
...
exports.default = setSwingAmount;
...
function findAmounts(sellObj, buyObj, stats, swingTradeAmount) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, sellAmount, flag;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4, firstTier(sellObj, buyObj, stats, swingTradeAmount)];
                case 1:
...
function firstTier(sellObj, buyObj, stats, swingTradeAmount) {
    return __awaiter(this, void 0, void 0, function () {
        var amount, amountBuy, sellStd, buyStd, sellAmount;
        return __generator(this, function (_a) {
            amount = parseFloat(sellObj.balance);
            amountBuy = parseFloat(buyObj.balance);
            sellStd = stats.avg - stats.stdev2;
            buyStd = stats.avg + stats.stdev2;
...
//# sourceMappingURL=setSwingAmount.js.map